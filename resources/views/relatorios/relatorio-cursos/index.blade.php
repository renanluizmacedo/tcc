...
<div class="row">
    <div class="col">
        <h2 class="display-7 text-secondary d-none d-md-block"><b>Relatorio</b></h2>
    </div>
</div>
<div class="row">
    <div class="col">
        <table class="table align-middle caption-top table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a nohref style="cursor:pointer" onclick="showInfoModal('{{ $item->nome }}', '{{ $item->sigla }}', '{{ $item->tempo }} ANOS', '{{ $item->eixo->nome }}')" class="btn btn-warning">
                    ...
                    <td>
                        <a href="{{route('gerarRelatorioCurso',$item['id'],$item['nome'])}}" class="btn btn-primary">
