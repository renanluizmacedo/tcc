...
<div class="row">
    ...
    <div class="col d-flex justify-content-end">
        <a href= "{{ route('disciplinas.create') }}" class="btn btn-secondary">
                ...
                @foreach ($data as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            <a nohref style="cursor:pointer" onclick="showInfoModal('{{ $item->nome }} ({{ $item->ano }})', '{{ $item->curso->nome }}', '{{ $item->area->nome }}', '{{ $item->periodo }}° ANO', '{{ $item->carga }} AULAS')" class="btn btn-primary">
