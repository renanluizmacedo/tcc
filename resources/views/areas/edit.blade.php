...
<form action="{{ route('areas.update', $data->id) }}" method="POST">
    ...
    <div class="row">
        <div class="container my-3">
            <h3 class="display-7 text-secondary"><b>Alterar Área do Conhecimento</b></h3>
            <div class="row">
                <div class="col" >
                    <div class="form-floating mb-3">
                        <input 
                            ...
                            placeholder="Nome"
                        />
                        <label for="nome">Nome da Área do Conhecimento<label>
                        @if($errors->has('nome'))
            ...
            <div class="row">
                <div class="col">
                    <a href="{{route('areas.index')}}" class="btn btn-secondary btn-block align-content-center">
